...
This library started as the **42 School libft project** and was progressively extended while working on subsequent projects (ft_printf, get_next_line, push_swap, pipex, minishell...).

> Browse the original submission at tag [`v1.0-original`](../../releases/tag/v1.0-original)  
> The current extended version is tagged [`v2.0-extended`](../../releases/tag/v2.0-extended)
...
| `ft_strjoin2` | Enhanced strjoin with memory management flags |
